...
```
https://github.com/CerebralMastication/Presentations/tree/master/2019_08_EPA
...
## Workplaces Are Sad Silos {data-background=./fig/Sad_Cubicles_2.png}


## They Could be a Party! {data-background=./fig/Office-R-github.png}
...
## How do Analysts See Themselves... 
...
## Write & Save - openxlsx {.small-code}
...
* lets us do the work when we're less busy
* changes how frequently we look at our analysis
* makes the computer do the painful work
* reduces errors
...
## Python & R Interoperability  {.medium-body}

**rpy2** - Start in Python and run some R

Great for running R from Airflow 

**reticulate** - Start in R and run some Python

Great for running Python in R Markdown, Shiny, RStudio
...
## Design Patterns that Build Bridges

## {data-background=./fig/coupling.jpg data-background-size=cover}

## {data-background=./fig/train_mail.gif data-background-size=cover}

## Loosely Coupled Workflows

## {data-background=./fig/airflow.png }

## {data-background=./fig/api.png }

## Helper Tools Build Bridges

* esquisse - GUI for building ggplots

## {data-background=./fig/esquisse.gif }

## Helper Tools Build Bridges

* clipr - copy dataframes from RStudio (paste in Excel!)

<div align="center">
<img src="./fig/clipr.png" width=300 >
</div>

## Helper Tools Build Bridges

* datapasta - copy form Excel to R!

<div align="center">
<img src="./fig/datapasta.gif"  >
</div>
...
* We Can Lower the Friction to Helping Users Adopt Additional Tools
